...
console.log('Loading UnderscoreComparator qUnit configurations.');

define(['text!amd-test-config.json','underscore'], function(testConfigString, undef) {

    console.log('Loading UnderscoreComparator qUnit tests.');
    ...
    return require(tests, function() {
        console.log('Initializing UnderscoreComparator qUnit tests.');
